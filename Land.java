...
public class Land {
	...
	public static final int LAND_POSY = 190;
	...
	public Land(int width, MainCharacter mainCharacter) {
		...
		land1 = Resource.getResouceImage("data/b1.png");
		land2 = Resource.getResouceImage("data/b2.png");
		land3 = Resource.getResouceImage("data/b3.png");
